...
export const TASKS: Task[] = [
  ...
  },
  {
    id: 21,
    label: "Вершина мира",
    description: "Забраться на башню ми-го",
    help: [
      "Скорее всего, в этой башне вы и останетесь. В башне живут Чужие, с ними можно драться, а можно попробывать пробежать мимо.",
    ],
    weigth: 4,
    isCompleted: false,
  },
  ...
  {
    id: 30,
    label: "Кровь на руках",
    description: "Убить НПС",
    weigth: 3,
    isCompleted: false,
  },
  {
